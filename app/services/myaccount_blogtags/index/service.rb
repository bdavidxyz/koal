module MyaccountBlogtags::Index
  class Service < Servus::Base
    SORT_COLUMNS = %w[id name slug created_at updated_at].freeze
    ...
    def call
      success(blogtags: filtered_blogtags)
    end

    private
      def filtered_blogtags
        scope = Blogtag.order(sort_clause)
