...
class MyaccountBlogposts::Show::ServiceTest < ActiveSupport::TestCase
  test "returns the requested blogpost" do
    blogpost = blogposts(:first_blogpost)

    result = MyaccountBlogposts::Show::Service.call(slug: blogpost.slug)
  ...
  test "returns not found when the blogpost does not exist" do
    result = MyaccountBlogposts::Show::Service.call(slug: "missing-blogpost")
